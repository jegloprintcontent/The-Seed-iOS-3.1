...
struct DetailView: View {
    ...
    init(article: Article) {
        ...
        self.model = .init(article: article)
    }
    ...
    var body: some View {
       ...
       // ScrollView {
        ...
        .ignoresSafeArea()
        .navigationBarTitle(String(article.title.rendered), displayMode: .inline)
...
struct DetailView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        .navigationBarTitle(String("Title"), displayMode: .inline)
    }
}
